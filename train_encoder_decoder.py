...
def main():
    ...
    parser.add_argument('--params'    , type = bool , default = False                                      , help = 'Zero Param (GT Image) or Param Training (Synthetic Image)')
    ...
    parser.add_argument('--epoch'     , type = int  , default = 200                                        , help = 'Select Epoch Size (e.g 100)')
